...
(define tests '(simple_ret simple_add many_args if while while2 order_args for array struct heap_arr ptr bin_int linked_list bubble_sort quick_sort binary_search dijkstra))
